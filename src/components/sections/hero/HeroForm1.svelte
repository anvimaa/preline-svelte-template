<script lang="ts">
  let dataHsStrongPassword = {
    target: "#hs-hero-signup-form-floating-input-new-password",
    hints: "#hs-strong-password-popover",
    stripClasses:
      "hs-strong-password:opacity-100 hs-strong-password-accepted:bg-teal-500 h-2 flex-auto rounded-full bg-blue-500 opacity-50 mx-1",
    mode: "popover",
  };
</script>
    ...
    <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
      <div>
        ...
        <div class="mt-4 md:mb-12 max-w-2xl">
          <h1
            class="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-neutral-200"
          >
                  ...
                  <div class="relative col-span-full">
                    ...
                    >
                      <div
                        ...
                        data-hs-strong-password={dataHsStrongPassword}
                      ...
                      <ul
                        class="space-y-1 text-sm text-gray-500 dark:text-neutral-500"
                      >
                        <li
