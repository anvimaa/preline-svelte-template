<!-- ========== HEADER ========== -->
<header
  class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm py-3 md:py-0 dark:bg-neutral-800"
>
  <nav
    ...
    <div class="relative md:flex md:items-center md:justify-between">
      ...
      >
        ...
        >
          ...
          >
            <a
              class="font-medium text-blue-600 py-3 md:py-6 dark:text-blue-500"
              href="#"
              aria-current="page">Landing</a
            >

            <a
              class="font-medium text-gray-800 hover:text-gray-600 py-3 md:py-6 dark:text-neutral-200 dark:hover:text-neutral-500"
              href="#"
            >
              Company
            </a>
                ...
                <div class="grid grid-cols-2 md:grid-cols-10">
                  <div class="md:col-span-3">
                    <div class="flex flex-col py-6 px-3 md:px-6">
                      <div class="space-y-4">
                        <span
                          class="mb-2 text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200"
                          >About us</span
                        >

                        <a
                          class="flex gap-x-4 text-gray-800 hover:text-blue-600 dark:text-neutral-200"
                          href="#"
                        >
                          <svg
                  ...
                  <div class="col-span-full md:col-span-4">
                    <div
                      class="flex flex-col bg-gray-50 p-6 dark:bg-neutral-700"
                    >
                      <span
