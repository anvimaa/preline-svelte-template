  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
    ...
    >
      <div class="p-4 md:p-5 flex justify-between gap-x-3">
        <div>
          ...
          <div class="mt-1 flex items-center gap-x-2">
            ...
            <span class="flex items-center gap-x-1 text-green-600">
              <svg
                class="inline-block size-5 self-center"
        ...
        <div
          class="flex-shrink-0 flex justify-center items-center size-[46px] bg-blue-600 text-white rounded-full dark:bg-blue-900 dark:text-blue-200"
        >
          <svg
      ...
      <a
        class="py-3 px-4 md:px-5 inline-flex justify-between items-center text-sm text-gray-600 border-t border-gray-200 hover:bg-gray-50 rounded-b-xl dark:border-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-800"
        href="#"
      >
        View reports
        <svg
    ...
    >
      <div class="p-4 md:p-5 flex justify-between gap-x-3">
        <div>
          ...
          <div class="mt-1 flex items-center gap-x-2">
            <h3
              class="mt-1 text-xl font-medium text-gray-800 dark:text-neutral-200"
            >
              29.4%
            </h3>
          </div>
