            ...
            <div>
              <div class="inline-flex gap-x-2">
                ...
                >
                  ...
                  <div
                    class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-48 z-20 bg-white shadow-md rounded-lg p-2 mt-2 dark:divide-neutral-700 dark:bg-neutral-800 dark:border dark:border-neutral-700"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <label
                        for="hs-as-filters-dropdown-frequency"
                      ...
                      <label
                        for="hs-as-filters-dropdown-status"
                        class="flex py-2.5 px-3"
                      >
                        <input
                          type="checkbox"
                      ...
                      <label
                        for="hs-as-filters-dropdown-created"
                        class="flex py-2.5 px-3"
                      >
                        <input
                          type="checkbox"
                      ...
                      <label
                        for="hs-as-filters-dropdown-due-date"
                        class="flex py-2.5 px-3"
                      >
                        <input
                          type="checkbox"
                      ...
                      <label
                        for="hs-as-filters-dropdown-amount"
                        class="flex py-2.5 px-3"
                      >
                        <input
                          type="checkbox"
              ...
              >
                <td class="size-px whitespace-nowrap">
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2">
                      <div
                        class="block text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500"
                      >
                        #digitalmarketing
                      </div>
                    </div>
                ...
                <td class="size-px whitespace-nowrap">
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2 flex gap-x-1">
                      <svg
                        class="flex-shrink-0 size-3 text-gray-800 dark:text-neutral-200"
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        fill="currentColor"
                      ...
                      <svg
                        class="flex-shrink-0 size-3 text-transparent"
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        fill="currentColor"
                  ...
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2 flex -space-x-2">
                      <div class="hs-tooltip inline-flex">
                        <img
                          class="hs-tooltip-toggle inline-block size-6 rounded-full ring-2 ring-white dark:ring-neutral-900"
                ...
                <td class="size-px whitespace-nowrap">
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2 flex -space-x-2">
                      <div class="hs-tooltip inline-flex">
                        <span
                          class="hs-tooltip-toggle inline-flex items-center justify-center size-6 rounded-full bg-gray-600 ring-2 ring-white dark:bg-neutral-400 dark:ring-neutral-900"
                        >
                          <span
                            class="text-xs font-medium text-white leading-none"
                            >A</span
                          >
                        </span>
                        <span
              ...
              >
                ...
                <td class="h-px w-72 min-w-72">
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2">
                      <p class="text-sm text-gray-500 dark:text-neutral-500">
                        Software testers play a critical role in application
                        development. They are quality assurance experts who put
                        applications
                      </p>
                    </div>
                  </a>
