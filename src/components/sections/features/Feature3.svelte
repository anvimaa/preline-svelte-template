  ...
  <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
    ...
    <div class="max-w-3xl mb-10 lg:mb-14">
      ...
      <p class="mt-1 text-neutral-400">
        ...
        meticulous research and strategic planning to the seamless execution of
        brand development and website or product deployment.
      </p>
    </div>
    <!-- End Title -->
    ...
    <!-- Grid -->
    <div
      class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center"
    >
        ...
        <div class="flex gap-x-5 ms-1">
          ...
          <div class="grow pt-0.5 pb-8 sm:pb-12">
            <p class="text-sm lg:text-base text-neutral-400">
              ...
              Develop digital products or services that address the needs and preferences
        ...
        <div class="flex gap-x-5 ms-1">
          ...
          <div class="grow pt-0.5 pb-8 sm:pb-12">
            <p class="text-sm md:text-base text-neutral-400">
              ...
              Launch your digital products or services to the market, closely monitoring
              their performance and user feedback.
            </p>
          </div>
          <!-- End Right Content -->
        </div>
