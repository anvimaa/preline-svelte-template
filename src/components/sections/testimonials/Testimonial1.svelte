...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  >
    <div class="lg:col-span-5 lg:col-start-1">
      ...
      <div class="mb-8">
        <h2
          class="mb-2 text-3xl text-gray-800 font-bold lg:text-4xl dark:text-neutral-200"
        >
          It's all about speed
        </h2>
        <p class="text-gray-600 dark:text-neutral-400">
          We provide you with a test account that can be set up in seconds. Our
          main focus is getting responses to you as soon as we can.
        </p>
      </div>
      <!-- End Title -->
    ...
    <div class="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
      <div class="space-y-6 sm:space-y-8">
        <!-- List -->
        <ul
          class="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-gray-200 overflow-hidden dark:divide-neutral-700"
        >
          <li class="flex flex-col -m-0.5 p-4 sm:p-8">
            <div
              class="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2 dark:text-neutral-200"
            >
              45k+
            </div>
          ...
          <li class="flex flex-col -m-0.5 p-4 sm:p-8">
            ...
            >
              <svg
                class="flex-shrink-0 size-5 text-blue-600 dark:text-blue-500"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
