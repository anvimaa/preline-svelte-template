  ...
  <div class="overflow-hidden">
        ...
        <div class="relative md:flex md:items-center md:justify-between">
          <div class="flex items-center justify-between">
            <a class="flex-none" href="#">
              ...
              >
                <path
                  ...
                  fill="currentColor"
                  class="fill-violet-600 dark:fill-white"
                />
                <path
                  ...
                  class="stroke-violet-600 dark:stroke-white"
                  stroke="currentColor"
                  stroke-width="2"
                />
                <path
            ...
            <div class="md:hidden">
              <button
                type="button"
                class="hs-collapse-toggle size-9 flex justify-center items-center text-sm font-semibold rounded-lg border border-gray-200 text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-neutral-800 dark:hover:bg-neutral-700"
          ...
          >
            ...
            >
              <div
                class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-neutral-700"
              >
                <a
                  class="font-medium text-gray-600 hover:text-gray-500 py-3 md:py-6 dark:text-neutral-400 dark:hover:text-neutral-500"
                  href="#"
                  aria-current="page"
                >
                  Landing
                ...
                >
                  ...
                  <div
                    class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full start-0 min-w-60 bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-neutral-900 dark:divide-neutral-700 before:absolute before:-top-5 before:start-0 before:w-full before:h-5"
                  >
                    <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div class="flex flex-col mx-1 md:mx-0">
                        <a
                          class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-800"
                          href="#"
                        >
                          <svg
                          ...
                          <div class="grow">
                            ...
                            <p
                              class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200"
                            >
                      ...
                      <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                        ...
                        >
                          ...
                          <div class="grow">
                            ...
                            <p
                              class="mt-3 inline-flex items-center gap-x-2 text-sm font-semibold text-gray-800 dark:text-neutral-200"
                            >
                              Learn more
                              <svg
                ...
                <div class="pt-3 md:pt-0">
                  <a
                    class="py-2.5 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-violet-900 text-white hover:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                    href="#"
                  >
                    Request demo
                  </a>
    ...
    <div class="relative">
      ...
      <div class="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
        ...
        <!-- Grid -->
        <div
          class="mt-6 md:mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center"
        >
          <!-- Card -->
          <div
            class="flex flex-col bg-white border border-gray-200 text-center rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-neutral-800"
          >
            <h4 class="font-medium text-lg text-gray-800 dark:text-neutral-200">
              Free
            </h4>
            <span
              class="mt-7 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-800 dark:text-neutral-200"
              >Free</span
            >
            ...
            <ul class="mt-7 space-y-2.5 text-sm">
              <li class="flex space-x-2">
                <svg
                  class="flex-shrink-0 mt-0.5 size-4 text-violet-900"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
          ...
          <!-- Card -->
          <div
            class="flex flex-col bg-white border-2 border-violet-900 text-center shadow-xl rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-violet-700"
          >
            <p class="mb-3">
              <span
                class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-lg text-xs uppercase font-semibold bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-white"
                >Most popular</span
              >
            </p>
            <h4 class="font-medium text-lg text-gray-800 dark:text-neutral-200">
            ...
            <span
              class="mt-5 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-800 dark:text-neutral-200"
            >
              $39
            </span>
            <p class="mt-2 text-sm text-gray-500 dark:text-neutral-500">
            ...
            <a
              class="mt-5 py-3 px-4 w-full inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-violet-600 text-white hover:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
        ...
        <!-- Title -->
        <div
          class="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mt-10 md:mt-14 mb-6 lg:mt-24"
        >
        ...
        <div class="flex justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
          <svg
            class="size-16 md:size-20 lg:size-24 mx-auto sm:mx-0 text-gray-500 dark:text-neutral-500"
    ...
    >
      ...
      <div class="space-y-4 lg:space-y-0">
        ...
        <ul class="grid lg:grid-cols-6 lg:gap-6">
          ...
          <li class="lg:col-span-2 pb-1.5 lg:py-3">
            <span
              class="font-semibold lg:font-normal text-sm text-gray-800 dark:text-neutral-200"
            >
              Number of seats
            </span>
          </li>
          ...
          <!-- Item -->
          <li
            class="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-800"
          >
            <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
              <span
                class="lg:hidden md:col-span-2 text-sm text-gray-800 dark:text-neutral-200"
              >
                Free
              </span>
        ...
        <ul class="grid lg:grid-cols-6 lg:gap-6">
          ...
          >
            <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
              ...
              <svg
                class="flex-shrink-0 size-5 text-violet-600 dark:text-violet-500"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <ul class="grid lg:grid-cols-6 lg:gap-6">
          ...
          >
            <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
              ...
              <svg
                class="flex-shrink-0 size-5 text-gray-400 dark:text-neutral-600"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      <div class="hidden lg:block mt-6">
        ...
        <div class="grid grid-cols-6 gap-6">
          ...
          <div class="col-span-1">
            <a
              class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-violet-600 text-white hover:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
              href="#"
            >
              Get started
            </a>
      ...
      <div class="mt-3 grid space-y-3 text-sm">
        ...
        <p>
          <a
            ...
            href="#">Careers</a
          >
          <span class="inline text-violet-600 dark:text-violet-500"
            >— We're hiring</span
          >
        </p>
        <p>
      ...
      <div class="mt-3 grid space-y-3 text-sm">
        ...
        <p>
          <a
            ...
            href="#">GitHub</a
          >
          <span class="inline text-violet-600 dark:text-violet-500">— New</span>
        </p>
      </div>

      <h4
        class="mt-7 text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100"
      >
        Industries
      </h4>
